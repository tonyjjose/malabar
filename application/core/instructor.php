...
class Instructor extends user
{
        ...
        $mobile, $address, $approved, $active, $anon, $created, $last_login)
    {
        ...
        $mobile, $address, NULL, ROLE_INSTRUCTOR, $approved, $active, $anon, $created, $last_login);
    }
    /**
    ...
    public static function getAllInstructors()
    {
        ...
        $query = $db->query("SELECT * FROM users WHERE user_type = 'ROLE_INSTRUCTOR' ORDER BY user_name ASC");   
        $rows = $query->fetchAll();
